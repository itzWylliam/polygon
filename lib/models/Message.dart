...
class Message extends amplify_core.Model {
  ...
  const Message._internal({required this.id, required content, required deleted, required author, required chat, createdAt, updatedAt}): _content = content, _deleted = deleted, _author = author, _chat = chat, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Message({String? id, required Content content, required bool deleted, required String author, required String chat}) {
  ...
  Message copyWith({Content? content, bool? deleted, String? author, String? chat}) {
    return Message._internal(
      id: id,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'content': _content?.toJson(), 'deleted': _deleted, 'author': _author, 'chat': _chat, 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  ...
  static final CHAT = amplify_core.QueryField(fieldName: "chat");
  static var schema = amplify_core.Model.defineSchema(define: (amplify_core.ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.indexes = [
      amplify_core.ModelIndex(fields: const ["author"], name: "byMessageAuthor"),
      amplify_core.ModelIndex(fields: const ["chat"], name: "byMessageOfChat")
    ];
